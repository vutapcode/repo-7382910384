...
class BinanceAPI:
    ...
    async def new_listen_key(self):
        return await self._call(self.client.new_listen_key)

    async def renew_listen_key(self, listen_key):
        return await self._call(self.client.renew_listen_key, listenKey=listen_key)

    async def close_listen_key(self, listen_key):
        return await self._call(self.client.close_listen_key, listenKey=listen_key)
