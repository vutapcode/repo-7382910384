...
1. `DECISION_EVALUATED` mang `TIER_S_DECISION_RECORD_V5_AVAILABILITY_TIME`: cùng một `cycle_id`
   ...
   Spot-Perp/Coinbase/exchange-independence, signed `distance_to_boundary`
   cho từng authority gate và output
