...
SERVICES = {
    'bot': f'{SERVICE_PREFIX}-bot.service',
    'recorder': f'{SERVICE_PREFIX}-recorder.service',
    'health': f'{SERVICE_PREFIX}-health.service',
}
if SERVICE_PREFIX == 'smc2026':
    SERVICES['gemini_shadow'] = 'smc2026-gemini-shadow.service'
