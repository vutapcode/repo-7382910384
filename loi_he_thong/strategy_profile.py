...
PROFILE_VERSION = "TIER_S_STRATEGY_PROFILE_V20_POSITION_ROOT_PROCESS_SPLIT"
...
_PROFILE = {
    ...
    "architecture": (
        ...
        "CROSS_CASH_CAUSAL_WAVE_V2_LINEAGE_TOMBSTONES",
        "FOUR_AUTHORITY_CONTRACTS_V1",
        "ENTRY_THESIS_HANDOFF_V1",
        "GUARDIAN_CANONICAL_THESIS_ACTION_V1",
        "GUARDIAN",
        "SHADOW_RISK",
    ),
    "evidence": (
    ...
    "invariants": (
        ...
        "GUARDIAN_EXIT_REQUIRES_CANONICAL_MARKET_TRUTH_TERMINAL_STATE",
        "POSITION_SIDE_IS_NOT_CAUSAL_WAVE_IDENTITY",
        "POSITION_ROOT_IS_NOT_TRANSIENT_CASH_PROCESS_LINEAGE",
        "ENTRY_REQUIRES_BOUND_MONITORABLE_POSITION_THESIS_SEED",
        "NEW_SAME_SIDE_WAVE_CANNOT_RESURRECT_DEAD_POSITION_THESIS",
        "SHORT_HORIZON_DIVERGENCE_CANNOT_TERMINALIZE_POSITION",
